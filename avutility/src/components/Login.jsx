            ...
            <div className="relative z-10 w-full max-w-[440px] flex flex-col gap-6">
                ...
                <div className="text-center mb-2">
                    ...
                    <p className="text-text-muted text-sm">
                        Sign in to access your media processing suite.
                    </p>
                </div>

                {/* Login Card */}
                <form onSubmit={handleLogin} className="flex flex-col gap-5 p-6 sm:p-8 rounded-[2rem] bg-[#16211b] border border-border-dark shadow-2xl">
                    {/* Email Input */}
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="mt-2 w-full bg-primary hover:bg-[#2ecc71] text-background-dark font-bold text-lg rounded-full h-14 transition-all hover:shadow-glow active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isLoading ? (
                            <>
                            ...
                            <>
                                <span>Enter Processing Suite</span>
